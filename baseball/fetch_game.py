...
HTML_INDEX_PAGE = (
    ...
    'document.getElementById("delay").innerHTML = "Current time delay: " + window.location.href.split(\'/\')[4];'
    '}}'
    '}}'
    'function applydelay() {{'
    'sec_delay = Math.ceil(document.getElementById("delay_seconds").value / 5) * 5; '
    'window.location = "/delay_volume/" + sec_delay + "/index.html"; ' 
    '}}'
    '</script>'
