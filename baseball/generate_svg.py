...
LOGO_DICT = {
    ...
    'SLB': 'team_logos/browns.png',
    'KCA': 'team_logos/kansasathletics.png',
    'PHA': 'team_logos/phillyathletics.png',
    'NYG': 'team_logos/nygiants.png',
    'BRO': 'team_logos/dodgers.png',
    'WAS': 'team_logos/senators.svg',
    'BSN': 'team_logos/bostonbraves.png',
    'ATH': 'team_logos/athletics.jpg',
...
def fix_pa(plate_appearance, event):
    ...
    elif 'Pickoff' in event.run_description:
        summary = 'PO'
        description = '{} batting: Pickoff'.format(plate_appearance.batter)
